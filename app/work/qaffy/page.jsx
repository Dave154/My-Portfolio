...
const workflows = [
  {
    ...
    description: "A customer-facing flow for placing laundry orders and tracking the journey from request to delivery.",
    image: `${assetPath}/Google-Pixel-6-PRO-qaffy-theta.vercel.app.png`,
    alt: "Qaffy customer laundry order interface",
  },
  {
    title: "Operations Workspace",
    description: "Role-specific tools for coordinating customers, logistics, vendors, and administration around the same order lifecycle.",
    image: `${assetPath}/Screenshot 2026-09-17 142105.png`,
    alt: "Qaffy laundry operations dashboard",
  },
  {
    title: "Business Workflow",
    description: "The system accounts for real operational cases such as quantity mismatches, subscription allowances, billing, handoffs, and reconciliation.",
    image: `${assetPath}/Grey Bold Collage Business Insights LinkedIn Post.png`,
    alt: "Qaffy business workflow overview",
  },
];
